    ...
    return (
        <div>
            {isLoggedIn &&
                ...
                >
                    <BottomNavigationAction label={<Link className='btns' to='/posting/'>빌리기</Link>} icon={<ChevronRight />}/>
                    <BottomNavigationAction label={<Link className='btns' to='/posting/'>빌리기 목록</Link>} icon={<Checklist />}/>
                    <BottomNavigationAction label={<Link className='btns' to='/posting/'>내 상태</Link>} icon={<Badges counter={counter} />}/>
            ...
            {!isLoggedIn && 
                ...
                >
                    <BottomNavigationAction label={<Link className='btns' to='/posting/'>빌리기 목록</Link>} icon={<Checklist />}/>
                    <BottomNavigationAction label={<Link className='btns' to='/posting/'>로그인</Link>} icon={<BeachAccess />}/>
                    <BottomNavigationAction label={<Link className='btns' to='/posting/'>빌려주기 목록</Link>} icon={<ChecklistRtl />}/>
                </BottomNavigation>
            }
        </div>
